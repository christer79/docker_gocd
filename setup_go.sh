...
docker run --name go_server --publish 8153:8153 --publish 8154:8154 --volume $(pwd)/backups:/var/lib/go-server/artifacts/serverBackups -d gocd /root/start-server.sh 
